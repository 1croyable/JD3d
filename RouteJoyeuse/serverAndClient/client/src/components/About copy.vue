<template>
    <div>
        ...
        <iframe class="fadeIn" ref="iframe" frameborder="0" fullscreen src="../../public/models/logoCubeBorder.html"
            width="100%" height="100%"
            style="z-index: -1; position: absolute; bottom: -1vh; right: -2vw; border: none; overflow: hidden; opacity: 0;"></iframe>
        <!-- 导航栏 -->
    ...
    <!-- 内容主体 -->
    <div ref="animatedBlock" class="animated-block animate__animated animate__bounceInLeft"></div>
</template>
